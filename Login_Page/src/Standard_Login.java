...
public class Standard_Login extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Standard_Login frame = new Standard_Login();
	...
	public Standard_Login() {
		...
		JLabel lblWelcomeStandardUser = new JLabel("Welcome Standard User ");
